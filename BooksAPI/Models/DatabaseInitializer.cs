namespace BooksAPI.Models
{
    ...
    internal sealed class DatabaseInitializer : CreateDatabaseIfNotExists<BooksAPIContext>
    {
        ...
        new Book() { BookId = 1, ExternalId = 1,  Title= "Midnight Rain", Genre = "Fantasy",
        PublishDate = new DateTime(2000, 12, 16), AuthorId = 1, Description =
        "A former architect battles an evil sorceress.", Price = 14.95M },

        new Book() { BookId = 2, ExternalId =2, Title = "Maeve Ascendant", Genre = "Fantasy",
        ...
        new Book() { BookId = 3, ExternalId = 3, Title = "The Sundered Grail", Genre = "Fantasy",
        ...
        new Book() { BookId = 4, ExternalId = 4, Title = "Lover Birds", Genre = "Romance",
        ...
        new Book() { BookId = 5, ExternalId = 5, Title = "Splish Splash", Genre = "Romance",
